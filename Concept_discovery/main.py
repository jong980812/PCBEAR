...
def concept_decovery(args):
    ...
    closest_sample_indices = labeling.labeling(args,data,result_gt,save_path)
    visualize.concept_visualize(args,data,result_gt,closest_sample_indices,save_path)
